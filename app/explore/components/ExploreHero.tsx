        ...
        <div className="relative h-[450px] rounded-[2.5rem] bg-slate-100 overflow-hidden border border-gray-200 shadow-2xl shadow-indigo-900/10 transition-all">
          ...
          <div className="absolute inset-0 flex flex-col justify-center px-8 md:px-16 gap-6 z-10">
            ...
            <div className="space-y-4">
              ...
              <p className="text-slate-300 text-xs md:text-sm font-semibold uppercase tracking-widest max-w-sm">
                Step into real-world scenarios and master conversational English
                naturally.
              </p>
            </div>

            <button className="bg-white text-slate-900 px-6 py-3 rounded-2xl font-semibold text-xs uppercase tracking-widest flex items-center gap-3 w-fit transform translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500 shadow-xl">
